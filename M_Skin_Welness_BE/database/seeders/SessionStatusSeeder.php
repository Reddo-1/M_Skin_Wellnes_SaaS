...
class SessionStatusSeeder extends Seeder
{
    ...
    {
        $statuses = [
            ['id' => 1, 'name' => 'confirmada',     'sort_order' => 1],
            ['id' => 2, 'name' => 'en_curso',       'sort_order' => 2],
            ['id' => 3, 'name' => 'realizada',      'sort_order' => 3],
            ['id' => 4, 'name' => 'cancelada',      'sort_order' => 4],
            ['id' => 5, 'name' => 'no_presentada',  'sort_order' => 5],
        ];
